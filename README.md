...
m1 = 6.3*sin(2*%pi*485*t);
m2 = 6.4*sin(2*%pi*495*t);
m3 = 6.5*sin(2*%pi*505*t);
m4 = 6.6*sin(2*%pi*515*t);
m5 = 6.7*sin(2*%pi*525*t);
m6 = 6.8*sin(2*%pi*535*t);
...
<img width="719" height="526" alt="image" src="https://github.com/user-attachments/assets/cd93d930-e564-4d49-977a-eeec0d263528" />

<img width="712" height="528" alt="image" src="https://github.com/user-attachments/assets/0f257565-25cc-46ea-b21a-f6c9c68ea42e" />

<img width="718" height="527" alt="image" src="https://github.com/user-attachments/assets/83c9bce4-9d99-4ba9-9bbd-aea964676796" />

## CALCULATION

<img width="753" height="1280" alt="image" src="https://github.com/user-attachments/assets/771b9c54-5d1c-4216-a802-136523d9d6f6" />

<img width="771" height="1280" alt="image" src="https://github.com/user-attachments/assets/82745a83-baac-400d-99a9-353f9c1e64d3" />
